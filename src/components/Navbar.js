...
const Navbar = ({ activeSection, onNavigate, onRefresh, hasItinerary, isDark, onToggleTheme, user, onUserChange }) => {
  ...
  const styles = {
    ...
    loginBtn: { backgroundColor: '#10b981', color: 'white', padding: '12px 28px', borderRadius: '9999px', fontWeight: '700', fontSize: '17px', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 4px 12px rgba(16, 185, 129, 0.3)', transition: 'background-color 0.2s' },
